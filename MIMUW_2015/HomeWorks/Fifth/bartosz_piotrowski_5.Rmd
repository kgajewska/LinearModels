...
Tworzymy symulację następującej postaci: dla każdej liczby pacjentów n z przedziału [20:500] tworzymy 100 modeli z efektami zagnieżdżonymi (takimi, jak każe treść zadania) i na tej podstawie liczymy moc testu dla efektów zagnieżdżonych. 
```{r}
N1 <- 20
N2 <- 500
M <- 100
